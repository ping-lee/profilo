---
title: '第一篇示例文章'
subtitle: '使用Next JS重新编码的第一篇示例文章'
excerpt: 经过多次的编写，重写，这无疑是最后一次改动。文字编辑使用Markdown语法以及在Markdown中切入JS语言，使用多页面展现丰富的内容，同时文章编辑遵从简洁，清晰的原则，尽量减少图片和冗余的内容，其目的是保证文章内容的质量。
showToc: true
---
