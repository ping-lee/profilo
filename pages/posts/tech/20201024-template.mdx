---
title: '第一篇示例文章'
subtitle: '使用Next JS重新编码的第一篇示例文章，最好的文章标题应该有多长？'
excerpt: 经过多次的重构，编码，这一次无非是让我最满意的一个版本。文字编辑使用Markdown语法以及在Markdown中切入JS语言，使用多页面展现丰富的内容，同时文章编辑遵从简洁，清晰的原则，尽量减少图片和冗余的内容，其目的是保证文章内容的质量。
showToc: true
---
...
```bash
npm i @chakra-ui/core@next framer-motion
# or
